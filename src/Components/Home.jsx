...
export default function Home() {
    ...
    return (
        <>
            ...
            <div className='flex justify-center items-center   md:flex-row flex-col md:h-[100vh]  md:mt-[-50px] m-auto  mx-2 md:my-24 my-[-100px] md:mx-12 mb-44 md:mb-0 overflow-hidden'>
