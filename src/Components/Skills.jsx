...
<div className='heading flex mx-10 lg:mx-36 mb-8 md:my-8 my-14'>
    ...
    <div className='h-1 w-14 ml-4 my-4 bg-orange-500'></div>
                ...
                <div className='first-row flex justify-center  items-center mx-4 mt-12'>
                    <span className='flex justify-center items-center sm:flex-row flex-col'>
                    <div class="hexagon-wrapper mx-2">
                        <div class="hexagon shadow-lg shadow-slate-900">
                            <div class="hexagon-inner">
                                {/* <FaJava className='h-10 w-10 text-white object-cover ' /> */}
                                <img src={javaimage} alt="Hexagonal Img" class="h-16 w-10 object-cover " />
                            </div>
                        </div>
                    </div>
...
<span className='flex justify-center items-center sm:flex-row flex-col'>
                    ...
                    <div class="hexagon-wrapper mx-2">
                        <div class="hexagon shadow-lg shadow-slate-900">
                            <div class="hexagon-inner">
                                {/* <FaJava className='h-10 w-10 text-white object-cover ' /> */}
                                <img src="https://imgs.search.brave.com/2sAYcb_8ll9cQ4tYbEze1z-TTJlZ5EnZiMtffFaoQCw/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9icmFu/ZHNsb2dvcy5jb20v/d3AtY29udGVudC91/cGxvYWRzL2ltYWdl/cy9jLWxvZ28ucG5n" alt="Hexagonal Img" class="h-14 w-13 object-cover " />
                            </div>
                        </div>
                    </div>
